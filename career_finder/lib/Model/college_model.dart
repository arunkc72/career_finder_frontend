...
class College {
  ...
  College copyWith({
    ...
    return College(
      ...
      college_city_latitude:
          college_city_latitude ?? this.college_city_latitude,
      college_city_longitude:
          college_city_longitude ?? this.college_city_longitude,
      college_address_latitude:
          college_address_latitude ?? this.college_address_latitude,
      college_address_longitude:
          college_address_longitude ?? this.college_address_longitude,
  ...
  factory College.fromMap(Map<String, dynamic> map) {
    return College(
      ...
      college_city_name: map['college_city_name'] != null
          ? map['college_city_name'] as String
          : null,
      college_address: map['college_address'] != null
          ? map['college_address'] as String
          : null,
      ...
      college_city_latitude: map['college_city_latitude'] != null
          ? map['college_city_latitude'] as double
          : null,
      college_city_longitude: map['college_city_longitude'] != null
          ? map['college_city_longitude'] as double
          : null,
      college_address_latitude: map['college_address_latitude'] != null
          ? map['college_address_latitude'] as double
          : null,
      college_address_longitude: map['college_address_longitude'] != null
          ? map['college_address_longitude'] as double
          : null,
      distance_rank:
          map['distance_rank'] != null ? map['distance_rank'] as double : null,
    );
  }
  ...
  bool operator ==(covariant College other) {
    ...
    return other.college_name == college_name &&
